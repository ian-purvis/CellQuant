...
class RunConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if segment["engine"] != "v4":
            raise ValueError("scientific parity profile requires Cellpose v4")
        ...
        if float(segment["diameter_px"]) <= 0:
            raise ValueError("segment.diameter_px must be positive")
