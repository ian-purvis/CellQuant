...
def open_volume(
    ...
    *,
    ...
    elif any(value is None for value in detected_spacing):
        # require_spacing below will raise; still label the unknown state.
        calibration_status = "unknown"
        spacing_source = "unknown"
    else:
        calibration_status = "calibrated"
        spacing_source = "metadata"
    metadata = {
        **details,
        ...
        "canonical_axes": "ZYXC",
        "series": int(details.get("series", series)),
