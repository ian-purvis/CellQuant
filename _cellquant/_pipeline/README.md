...
1. Double-click **`Open CellQuant.bat`** and choose **v4** or **v3** when prompted.
...
[`memory/2026-09-08-deferred-parameter-sweep.md`](memory/2026-09-08-deferred-parameter-sweep.md).
